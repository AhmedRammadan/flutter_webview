...
//
// void main() {
//   runApp(MaterialApp(home: Scaffold(appBar: AppBar(),body: PermissionHandlerWidget(),),));
// }
//
...
import 'package:flutter/material.dart';
import 'package:flutter_downloader_example/WebViewExample.dart';
import 'package:flutter_downloader_example/splash.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
      ...
      home: SplashScreen(platform: platform,),
      // home: new MyHomePage(
      //   title: 'Downloader',
      //   platform: platform,
      // ),
          ...
          IconButton(
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (c) => WebViewExample(platform: widget.platform,)));
              },
